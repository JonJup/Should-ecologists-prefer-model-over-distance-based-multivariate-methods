...
result.file = readRDS("drsg_all_results.RDS")
...
error_bar =  ggplot() +
 ...
 # vertical line indicating a p-value of 0.05 
   ...
   # theme related stuff 
      ...
      scale_y_discrete(labels = rep(c("CCA", "CQO", "dbRDA", "MvGLM"), times = 4)) +
      # choosing the theme 
...
ggplot2::ggsave(plot = error_bar,
                filename = "../../../plots/Result Section Plots/191202_error_bar_drsg.pdf",
                height = 20,
                width = 13,
                units = "cm")
