...
for (cca.i in 1:5) {
  ...
  data = readRDS(paste0("02_variable_abundance_communities/vac",cca.i,".RDS"))
...
sp.data <- decostand(sp.data, method = "log")
...
saveRDS(object = output, 
        file = paste0("02_variable_abundance_communities/vac_cca/vac",cca.i,"_cca_log_result.RDS"))
print(cca.i)
}
beepr::beep()
