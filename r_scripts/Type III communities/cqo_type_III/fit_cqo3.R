...
safe_cqo = safely(cqo)
p.values = c()
print(paste("Finished fitting model. Now calculating p-values. Started @ ", Sys.time()))
for (column in 31:34) {
      ...
      print(paste("P Value for Varaible", column, "calculated. Finished @", Sys.time()))
...
saveRDS(object = output, 
        file = "~/01_Uni/My Papers/1909_Should ecologists prefer model- over algorithm-based multivariate methods/r_scripts/reviewer_comments/02_variable_abundance_communities/vac_cqo/cqo_results/vac3_cqo_resuts.RDS")
