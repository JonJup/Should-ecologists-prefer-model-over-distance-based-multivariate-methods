...
setwd(here::here("r_scripts/reviewer_comments/01_different_response_same_gradient/drsg_cca/"))
...
for (i in 1:length(output.files)) {
   ...
   analysis.data <- data.frame(matrix(ncol = 6, nrow = 4))
   names(analysis.data) <- c("variable","test.statistic","p.value","model","runtime","method")
...
saveRDS(cca_combine, "cca_drsg_results.RDS")
