...
saveRDS(FNR, "../../result_data/06_false_negative_and_positive_rates/FNR_type_I.RDS")
saveRDS(FPR, "../../result_data/06_false_negative_and_positive_rates/FPR_type_I.RDS")
