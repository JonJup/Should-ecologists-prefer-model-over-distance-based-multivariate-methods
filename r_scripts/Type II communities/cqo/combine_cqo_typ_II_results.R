...
setwd(dir = "~/01_Uni/My Papers/1909_Should ecologists prefer model- over algorithm-based multivariate methods/r_scripts/reviewer_comments/01_different_response_same_gradient/drsg_cqo/cqo_results/")
...
saveRDS(cca_combine, "../../../03_analyse_results/cqo/cqo_drsg_results.RDS")
