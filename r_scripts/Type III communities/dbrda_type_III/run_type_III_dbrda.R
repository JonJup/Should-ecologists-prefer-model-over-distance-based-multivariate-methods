...
# Calculating dbRDA on type III communities with no transformation
...
setwd("~/01_Uni/My Papers/1909_Should ecologists prefer model- over algorithm-based multivariate methods/r_scripts/Type III communities/abundance_data/")
...
for (rda.i in 1:5) {
      ...
      saveRDS(
            object = output,
            file = paste0(
                  "../../../result_data/08_type_III_communities/type_III_dbRDA/",
                  rda.i,
                  "_dbrda_result.RDS"
            )
      )
