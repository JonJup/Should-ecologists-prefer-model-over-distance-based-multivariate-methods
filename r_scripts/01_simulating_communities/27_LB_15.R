...
# Now the species' response pararmeters are set:
    ...
    # maximal abundance
    c <-list("B" = list( list(c(100,100),c(100,100),c(100,100),c(100,100),c(100,100), c(100,100), c(100,100),c(100,100),c(100,100)),
                         list(c(100,100),c(100,100),c(100,100),c(100,100),c(100,100), c(100,100), c(100,100),c(100,100),c(100,100))))

    # optima
    ose <- seq(from = 5, to = 95, length.out = n+1)
    opt <-  list("B" = list(
                            list(c(ose[1],ose[2]),c(ose[2],ose[3]),c(ose[3],ose[4]),c(ose[4],ose[5]),c(ose[5],ose[6]),c(ose[6],ose[7]),c(ose[7],ose[8]),c(ose[8],ose[9]),c(ose[9],ose[10]) ),
                            list(c(ose[1],ose[2]),c(ose[2],ose[3]),c(ose[3],ose[4]),c(ose[4],ose[5]),c(ose[5],ose[6]),c(ose[6],ose[7]),c(ose[7],ose[8]),c(ose[8],ose[9]),c(ose[9],ose[10]) )
                            )
                 )
...
#------------------#
    ...
    Simulation.output <- list("data" = cbind(out.samp,envn), "Response.Type" = "LB", "Samples" = sites^2)
