...
%%% ---------------- %%%
    ...
    %\usepackage{epstopdf}
    % macro for arbitrary vertical line in tables 
	...
	%--------------------------------%
		\begin{figure}[ht]
			...
			\begin{center}
			    ...
			    \includegraphics[width = 1\linewidth]{manuscript/figures/Communities_trimmed_appended.eps}     
			   	\caption{
...
% 		To improve readability though, we will refer to environmental variables in the manner that species respond to them. \\
	...
	%------------------------------%
		...
		\begin{figure}[ht]
			\centering
			\includegraphics[width=1\linewidth]{manuscript/figures/190917_MTP_MM_FLOWCHART.eps}
			\caption{
...
\section{Results}
	...
	%------------------------------%
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[scale = 0.7]{manuscript/figures/FPNR.eps}
    ...
    \begin{figure}
        \centering
        \includegraphics[scale = 0.7]{manuscript/figures/190912_error_bar.eps}
...
% page break 		
    ...
    \begin{figure}[!htbp]
        \centering
        \includegraphics[scale = 0.4]{manuscript/figures/Arched_Dunn_Smyth.eps}
    ...
    \begin{figure}[!htbp]
        \centering
        \includegraphics[scale =0.6]{manuscript/figures/runtimeplot.eps}
        \caption{
