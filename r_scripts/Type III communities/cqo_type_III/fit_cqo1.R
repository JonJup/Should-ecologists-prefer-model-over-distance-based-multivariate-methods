...
# load data 
data = readRDS("02_variable_abundance_communities/vac1.RDS")
...
saveRDS(object = output, 
        file = "~/01_Uni/My Papers/1909_Should ecologists prefer model- over algorithm-based multivariate methods/r_scripts/reviewer_comments/02_variable_abundance_communities/vac_cqo/cqo_results/vac1_cqo_resuts.RDS")
